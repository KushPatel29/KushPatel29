...
## Seventeen public repos, one rule
...
**12,754 automated tests across the seventeen featured repos below**. A green badge here means *it runs*, not
...
[inventory decision studio](https://kushpatel29.github.io/inventory-analytics-app/) ·
...
The first two are prerendered static sites, so they open at once. The full
inventory app, which also takes uploads, runs on
[Render](https://inventory-analytics-app.onrender.com/) and takes about a
minute to wake. The other ten interactive destinations run on
...
[Inventory Analytics live decision studio](https://kushpatel29.github.io/inventory-analytics-app/)
...
| ⚡ [**Finance Decision Models in Excel and Power BI**](https://github.com/KushPatel29/excel-fpa-model) · [**utility workbook ↓**](https://github.com/KushPatel29/excel-fpa-model/raw/main/workbook/PGE_Utility_FPA_Model.xlsx) · [**Kestrel Bay ↓**](https://github.com/KushPatel29/excel-fpa-model/raw/main/examples/kestrel-bay/Kestrel_Bay_FPA_Model.xlsx) · [**Power BI**](https://github.com/KushPatel29/excel-fpa-model#the-same-numbers-in-power-bi) | Two models: Portland General Electric plan-vs-actual from EIA, FERC and NOAA, published in Excel and a seven-page PBIP/TMDL report, with a backtested load forecast; and the preserved Kestrel Bay distributor model for channel economics, PVM and working capital. 1,190 tests. | Excel, Power Query, Power Pivot, DAX, LINEST, scenario modelling, Power BI (PBIP/TMDL) |
| 🏛️ [**B.C. Local-Government Finance**](https://github.com/KushPatel29/bc-local-government-finance) · [**workbook ↓**](https://github.com/KushPatel29/bc-local-government-finance/raw/main/workbook/BC_Local_Government_Finance_Model.xlsx) | Every B.C. municipality, 2019–2024, from the Province's official filings. 90 files held to written contracts, a dbt model with 31 data tests, and an Excel plan for any of 161 municipalities. The 68 municipalities investing below renewal need are $570M a year short, and the pipeline catches the Province's own data defects. 181 tests. | Python, dbt, DuckDB, data contracts, Excel, Power Query, public-sector finance |
